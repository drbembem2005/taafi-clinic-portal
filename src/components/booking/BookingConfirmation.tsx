  ...
  return (
    <div>
      ...
      <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-md mb-6">
        <p className="text-sm text-yellow-800 flex items-start">
          ...
          <span>
            ...
            سيتم تأكيد الحجز عبر الواتساب، وسيتم التواصل معك قريباً لتأكيد موعدك.
          </span>
        </p>
      </div>
      ...
      <Button 
        ...
        className="w-full bg-green-600 hover:bg-green-700 text-white py-6 text-lg rounded-xl flex items-center justify-center gap-2"
      >
