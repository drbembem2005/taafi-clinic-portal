...
const Booking = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-brand-light to-white py-8 md:py-12">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-4">احجز موعدك الآن</h1>
      ...
      <section className="py-8 md:py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl md:text-2xl font-bold text-center text-gray-800 mb-8">مزايا الحجز الإلكتروني</h2>
            ...
            <div className="grid gap-6 md:grid-cols-3 text-center">
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-800 mb-2">توفير الوقت</h3>
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-800 mb-2">أمان وخصوصية</h3>
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-800 mb-2">دفع مرن</h3>
      ...
      <section className="py-8 md:py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-xl md:text-2xl font-bold text-center text-gray-800 mb-6">معلومات إضافية عن الحجز</h2>
            
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white rounded-lg shadow-md p-5">
                <h3 className="text-lg font-bold text-gray-800 mb-3">تعليمات الحجز</h3>
              ...
              <div className="bg-white rounded-lg shadow-md p-5">
                <h3 className="text-lg font-bold text-gray-800 mb-3">طرق التواصل</h3>
                <ul className="space-y-3 text-gray-700 text-sm md:text-base">
